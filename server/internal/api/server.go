...
func NewServer(logger *logging.Logger, port int, dbConn repository.Querier) *HTTPServer {
	...
	handlers := handlers.NewHandlers(environmentService, applicationService, endpointService)
